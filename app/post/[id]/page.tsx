...
const dummyComments: Comment[] = [
  {
    ...
    author: "Sam Rivera",
    timestamp: "1h ago",
    body: "<p>This is exactly the kind of thing I needed to read today, thanks for writing it up.</p>",
    likes: 3,
    liked: false,
    replies: [],
  },
  {
    ...
    author: "Devon Park",
    timestamp: "40m ago",
    body: "<p>Solid take. Following this thread.</p>",
    likes: 1,
    liked: false,
    replies: [],
  },
  {
    ...
    author: "Lena Ortiz",
    timestamp: "12m ago",
    body: "<p>Had almost the exact same experience last week, good to know I'm not the only one.</p>",
    likes: 0,
    liked: false,
    replies: [],
  },
