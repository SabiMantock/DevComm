...
const dummyComments = [
  {
    ...
    author: "Sam Rivera",
    timestamp: "2h ago",
    body: "<p>Really clean write-up, love seeing the tricky parts called out instead of just the happy path.</p>",
    likes: 2,
    liked: false,
    replies: [],
  },
  {
    ...
    author: "Devon Park",
    timestamp: "1h ago",
    body: "<p>Nice stack choice. Would love to see a follow-up post digging into the setup.</p>",
    likes: 4,
    liked: false,
    replies: [],
  },
  {
    ...
    author: "Lena Ortiz",
    timestamp: "20m ago",
    body: "<p>Bookmarking this, want to try building something similar.</p>",
    likes: 0,
    liked: false,
    replies: [],
  },
